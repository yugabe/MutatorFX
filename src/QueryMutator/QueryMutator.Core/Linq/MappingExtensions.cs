...
namespace MutatorFX.QueryMutator.Linq
{
    public static class MappingExtensions
    {
        ...
        {
            return source.Select(mapping.ToExpression(parameter));
        }
        ...
        {
            return source.Select(mapping.ToExpression(parameter).Compile());
        }
    }
}
