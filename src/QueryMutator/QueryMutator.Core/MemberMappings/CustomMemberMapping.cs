...
namespace MutatorFX.QueryMutator.MemberMappings
{
    ...
    {
        public CustomMemberMapping(ParameterExpression sourceParameter, Expression<Func<TTarget, TMember>> memberSelector, Expression<Func<TSource, TMember>> mappingExpression) 
        ...
        {
            return Expression.ReplaceParameter(SourceParameter).Body;
        }
    }
